...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'lee', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个理想主义的互联网博主', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.leeideal.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '互联网,技术分享,AI,网络营销,自媒体', // 网站关键词 英文逗号隔开
